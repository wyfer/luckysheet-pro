...
const menuButton = {
  ...
  initialMenuButton: function () {
    ...
    $("#luckysheet-icon-border-all").click(function () {
      ...
      // 做兼容处理
      // if (typeof cfg["borderInfo"] === "object") {
      //     cfg["borderInfo"] = [];
      // }
        ...
        $menuButton.find(".luckysheet-cols-menuitem").click(function () {
          ...
          if (itemvalue == "freezenRow") {
            ...
            if (luckysheetFreezen.freezenRealFirstRowColumn) {
              let row_st = 0;
              let top =
                Store.visibledatarow[row_st] - 2 + Store.columnHeaderHeight;
            ...
            if (
              ...
              return tooltip.info(
                locale_freezen.rangeRCOverErrorTitle,
                locale_freezen.rangeRCOverError
              );
            }
            let scrollTop = $("#luckysheet-cell-main").scrollTop();
            let row_st = luckysheet_searcharray(
    ...
    $("#luckysheet-icon-superFormula-btn").click(function () {
      ...
      let itemdata = [
        ...
        { text: "", value: "split", example: "" },
        {
          text: locale_superFormula.script,
          value: "script",
          example:
            '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-textwrap-wrap iconfont icon-jiaoben" style="user-select: none;"> </div> </div>',
        },
        {
          text: locale_superFormula.latex,
          value: "latex",
          example:
            '<div class="luckysheet-icon luckysheet-inline-block" style="user-select: none;opacity:1;"> <div aria-hidden="true" class="luckysheet-icon-img-container luckysheet-icon-img luckysheet-icon-textwrap-wrap iconfont icon-gongshi-genshi" style="user-select: none;"> </div> </div>',
        },
      ];
      let itemset = _this.createButtonMenu(itemdata);
