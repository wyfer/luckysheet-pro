...
import { luckysheetextendtable, luckysheetdeletetable, luckysheetDeleteCell, 
    setCellDynamicValue,
    deleteCellDynamicValue } from '../global/extend';
import { 
    jfrefreshgrid, 
    jfrefreshgridall, 
    jfrefreshgrid_rhcw,
...
export function rowColumnOperationInitial(){
    ...
    //关联属性配置（设置、删除）
    $("#luckysheet-dynamicCellsSet").click(function (event) {
        $("body .luckysheet-cols-menu").hide();
        luckysheetContainerFocus();
        ...
        if(Store.luckysheet_select_save.length > 1){
            ...
            setCellDynamicValue(Store.luckysheet_select_save[0]);
    });
    $("#luckysheet-dynamicCellsDel").click(function (event) {
        $("body .luckysheet-cols-menu").hide();
        luckysheetContainerFocus();
        ...
        deleteCellDynamicValue(Store.luckysheet_select_save[0]);
    });
