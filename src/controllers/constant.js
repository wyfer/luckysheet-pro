...
const gridHTML = function () {
  ...
  return `<div class="luckysheet">
    ...
    locale_info.rename
  }" style="visibility: visible; width: 149px;" data-tooltip="${
    locale_info.rename
  }"> 
                            </div> 
                            \${functionButton}
                        ...
                        <div class="luckysheet-stat-area"> 
                            <div class="luckysheet-sta-c">
                                ...
                                <div class="luckysheet-print-viewList">
                                    <div type="viewNormal" class="luckysheet-print-viewBtn luckysheet-print-viewNormal luckysheet-print-viewBtn-active" title="${
                                      locale_print.normalBtn
                                    }"><i class="icon iconfont luckysheet-iconfont-putong"></i></div>
                                    <div type="viewLayout" class="luckysheet-print-viewBtn luckysheet-print-viewLayout" title="${
                                      locale_print.layoutBtn
                                    }"><i class="icon iconfont luckysheet-iconfont-yemianbuju"></i></div>
                                    <div type="viewPage" class="luckysheet-print-viewBtn luckysheet-print-viewPage" title="${
                                      locale_print.pageBtn
                                    }"><i class="icon iconfont luckysheet-iconfont-fenyeyulan"></i></div>
                                </div>
    ...
    rightclick.column
                ...
                <div id="luckysheet-cols-rows-add">
                    ...
                    <div id="luckysheet-top-left-add-selected" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${
                          rightclick.to
                        }<span class="luckysheet-cols-rows-shift-left">${
    rightclick.left
  }</span>${rightclick.add}
                    ...
                    <div id="luckysheet-bottom-right-add-selected" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${
                          rightclick.to
                        }<span class="luckysheet-cols-rows-shift-right">${
    rightclick.right
  }</span>${rightclick.add}
                            <input type="text" class="luckysheet-mousedown-cancel" placeholder="${
                              rightclick.number
    ...
    rightclick.column
                    ...
                    <div id="luckysheet-column-row-width-selected" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">
                            <span class="luckysheet-cols-rows-shift-word luckysheet-mousedown-cancel">${
                              rightclick.column
                            }</span><span class="luckysheet-cols-rows-shift-size luckysheet-mousedown-cancel">${
    rightclick.width
  }</span>
                ...
                <div id="luckysheet-cols-rows-dynamic">
                    <div class="luckysheet-menuseparator luckysheet-mousedown-cancel" role="separator" style="display:block"></div>
                    <div id="luckysheet-dynamicCellsSet" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${rightclick.setDynamic}</div>
                    </div>
                    <div id="luckysheet-dynamicCellsDel" class="luckysheet-cols-menuitem luckysheet-mousedown-cancel">
                        <div class="luckysheet-cols-menuitem-content luckysheet-mousedown-cancel">${rightclick.deleteDynamic}</div>
                    </div>
                </div>
...
const sheetHTML =
  ...
  maskHTML =
    '<div class="luckysheet-modal-dialog-mask" id="luckysheet-modal-dialog-mask"></div>';
...
function sheetconfigHTML() {
  ...
  if (Object.values(config).every((ele) => !ele)) {
    $("#luckysheet-sheet-container-c").addClass(
      "luckysheet-sheet-container-menu-hide"
    );
    return "";
  }
...
const luckysheetlodingHTML = function (target, coverConfig) {
  ...
  const id = "luckysheet-loading-" + new Date().getTime();
  const loadingHtml = `
...
function customCellRightClickConfig() {
  const config = {
    ...
    useDynamic: true // use Dynamic state
  };
